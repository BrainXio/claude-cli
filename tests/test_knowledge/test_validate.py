...
class TestValidateKb:
    ...
    def test_empty_kb(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr(
            "claude_knowledge._config.STATE_FILE", tmp_path / "state.json"
        )
        ...
        monkeypatch.setattr(
            "claude_knowledge.validate.now_iso", lambda: "2024-01-15T10:00:00"
        )
...
""")
        ...
        monkeypatch.setattr(
            ...
            lambda: [concepts_dir / "article1.md", concepts_dir / "article2.md"],
        )
        monkeypatch.setattr(
            "claude_knowledge._utils.wiki_article_exists", lambda link: True
        )
...
""")
        ...
        monkeypatch.setattr(
            "claude_knowledge._utils.list_wiki_articles",
            lambda: [concepts_dir / "article1.md"],
        )
        monkeypatch.setattr(
...
class TestCheckOrphanPages:
    ...
    def test_no_orphan_pages(
        ...
        monkeypatch.setattr(
            "claude_knowledge._utils.count_inbound_links", lambda link, exclude=None: 1
        )
    ...
    def test_orphan_pages_detected(
        self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch
    ) -> None:
...
class TestCheckOrphanSources:
    ...
    def test_no_orphan_sources(
        ...
        (mock_kb_dir / "state.json").write_text(
            json.dumps({"ingested": {"2024-01-15.md": {"hash": "abc123"}}})
        )
        ...
        monkeypatch.setattr(
            "claude_knowledge._utils.list_raw_files",
            lambda: [daily_dir / "2024-01-15.md"],
        )
        monkeypatch.setattr(
            "claude_knowledge._utils.load_state",
            lambda: {"ingested": {"2024-01-15.md": {"hash": "abc123"}}},
        )
    ...
    def test_orphan_sources_detected(
        self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch
    ) -> None:
        ...
        monkeypatch.setattr(
            "claude_knowledge._utils.load_state", lambda: {"ingested": {}}
        )
        # Patch state file location to use our mock
        monkeypatch.setattr(
            "claude_knowledge._config.STATE_FILE", mock_kb_dir / "state.json"
        )
...
class TestCheckStaleArticles:
    ...
    def test_no_stale_articles(
        ...
        (mock_kb_dir / "state.json").write_text(
            json.dumps({"ingested": {"2024-01-15.md": {"hash": actual_hash}}})
        )
        ...
        monkeypatch.setattr(
            "claude_knowledge._utils.load_state",
            lambda: {"ingested": {"2024-01-15.md": {"hash": actual_hash}}},
        )
    ...
    def test_stale_articles_detected(
        self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch
    ) -> None:
        ...
        (mock_kb_dir / "state.json").write_text(
            json.dumps({"ingested": {"2024-01-15.md": {"hash": "oldhash"}}})
        )
        ...
        monkeypatch.setattr(
            "claude_knowledge._utils.load_state",
            lambda: {"ingested": {"2024-01-15.md": {"hash": "oldhash"}}},
        )
...
""")
    ...
    def test_missing_backlinks_detected(
        self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch
    ) -> None:
...
""")
    ...
    def test_sparse_articles_detected(
        self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch
    ) -> None:
