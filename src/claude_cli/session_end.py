...
def _run_session_end() -> None:
    ...
    logger = get_logger("session_end", REPORTS_LOGS / "flush.log")
    ...
    logger.info("SessionEnd fired: session=%s", session_id)
    ...
    logger.info("Spawned flush.py for session %s", session_id)
